...
import hexdoc_hexperience

from .__gradle_version__ import FULL_VERSION, GRADLE_VERSION
from .__version__ import PY_VERSION


class HexperiencePlugin(ModPluginImpl):
    @staticmethod
    @hookimpl
    def hexdoc_mod_plugin(branch: str) -> ModPlugin:
        return HexperienceModPlugin(branch=branch)


class HexperienceModPlugin(ModPluginWithBook):
    @property
    @override
    def modid(self) -> str:
        return "hexperience"
    ...
    def jinja_template_root(self) -> tuple[Package, str]:
        return hexdoc_hexperience, "_templates"
